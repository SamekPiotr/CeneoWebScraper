    ...
    if request.method == 'POST':
        ...
        if response.status_code == requests.codes['ok']:
            ...
            if opinions_count:
                ...
                opinions.score = opinions.stars.apply(lambda s: round(s*MAX_SCORE,1))
                statistics = {
                    ...
                    'recommendation_distribution' : opinions.authors_recommendation.value_counts(dropna=False).reindex([1,np.nan,0]).to_dict()
                }
